...
- Add connection-scoped GATT database enumeration, descriptor server definitions and client read/write operations, and real-device Write Without Response coverage.
