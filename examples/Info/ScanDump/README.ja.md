...
- `EspBleScanResult` — `address`、`addressType`、`rssi`、`connectable`、`scannable`、`name`、`serviceUuids[]` / `serviceUuidCount`、`manufacturerData`、`serviceData` / `serviceDataUuid`
- `scanResult.hasName()` / `hasManufacturerData()` / `hasServiceData()`
