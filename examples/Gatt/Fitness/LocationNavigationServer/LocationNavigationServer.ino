...
void loop()
{
  ...
  if (millis() - lastUpdate >= 1000)
  {
    ...
    ble.gattServer().setValue(locationAndSpeedCharacteristic, measurement, sizeof(measurement));
    ble.gattServer().notify(locationAndSpeedCharacteristic, measurement, sizeof(measurement));
  }
