...
- Legacy advertising and scanning with value-type scan results, non-connectable beacons, iBeacon (`EspBleIBeacon.h`), Eddystone URL/UID/TLM (`EspBleEddystone.h`), and service-data broadcast/receive
