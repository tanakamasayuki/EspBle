...
Legacy Advertising、Scanning、Central/Peripheral接続、汎用GATT Server/Client、Notify/Indicateの最初のvertical sliceを実装し、ESP32-S3 2台のPeerテストで検証しています。現在のAPIと`ble.update()`によるevent配送はMTU、Security、HID実装前の試行段階です。
