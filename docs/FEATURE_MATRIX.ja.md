...
| HID Mouse（Device / Host） | ✅ | 🔧 | HOGP mouse profileの追加 |
| HID Consumer Control（メディアキー） | ✅ | 🔧 | HOGP consumer profileの追加 |
| HID Gamepad | ✅ | 🔧 | HOGP gamepad profileの追加 |
| HID System Control（電源等） | ✅ | 🔧 | HOGP profileの追加 |
| 複合HID（keyboard+mouse等） | ✅ | 🔧 | Report Map拡張と複数Input Report |
