...
| Fitness Machine Service（FTMS） | — | ✅ | Fitness Machine Feature（0x2ACC）Read＋flags駆動のIndoor Bike Data（0x2AD2、speed 0.01 km/h・cadence 0.5/min・符号付きpower W）Notify。Server/Client example、Peer検証済み。Control Point（対話制御）は未対応 |
