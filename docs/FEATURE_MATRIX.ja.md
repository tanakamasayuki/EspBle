...
| Boot Protocol切替（Keyboard） | ✅ | ✅ | Protocol Mode 0x2A4E＋Boot Keyboard Input/Output 0x2A22/0x2A32。Boot Modeで8-byte Boot Reportへ自動切替、`onProtocolMode()`。Mouse Boot Report 0x2A33は未対応 |
