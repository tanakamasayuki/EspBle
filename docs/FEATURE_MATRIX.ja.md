...
| GATT Server（独自Service・Characteristic・Descriptor） | ✅ | 任意UUID、permission、binary-safeな値 |
| GATT Client（一覧/既知UUID Discovery・Read・Write） | ✅ | Service/Characteristic/Descriptor snapshot、Descriptor操作、Write Without Response |
