...
| Dual Hostの仕組み（Controller / Host、HCI broker、routing、flow control、lifecycle、source / `.a`構成） | [GUIDE_DUAL_HOST.ja.md](GUIDE_DUAL_HOST.ja.md)（英語版: [GUIDE_DUAL_HOST.md](GUIDE_DUAL_HOST.md)） |
...
| PCMFlowBluetoothへのA2DP検証・修正依頼（完了済みの履歴） | [REQUEST_PCMFLOWBLUETOOTH_A2DP_VALIDATION.ja.md](REQUEST_PCMFLOWBLUETOOTH_A2DP_VALIDATION.ja.md) / [完了報告](https://github.com/tanakamasayuki/PCMFlowBluetooth/blob/main/docs/A2DP_VALIDATION_REPORT.ja.md) |
