...
- Unit test: keymap変換、HID Report Map parser、BLE MIDI codec、IEEE-11073 medical float codec、CGM E2E-CRC codec、iBeacon codec、Eddystone URL/UID/TLM codec
- Example compile: ESP32-S3向け81 example
