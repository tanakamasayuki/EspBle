...
- callback event queueは満杯時にNotificationのみをdropし（lifecycleイベントは保持）、drop数を`droppedEventCount()`で観測できますが、容量のcompile-time設定とoverflowイベントAPIは未確定です。GATT payloadの最終的なbyte container型も未確定です。
...
- [仕様・実装レビュー報告 2026-07-16](REVIEW_2026-07-16.ja.md)（消化後に削除）
