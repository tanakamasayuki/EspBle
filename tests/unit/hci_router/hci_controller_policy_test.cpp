...
int main()
{
  ...
  const uint16_t classicRadio[] = {
    0x0405, 0x0409, 0x040a, 0x040b, 0x040c, 0x040d, 0x040e, 0x0419,
    0x042b, 0x042c, 0x042d, 0x042e, 0x042f, 0x0430, 0x0433, 0x0434,
    0x080f,
    0x0c12, 0x0c13, 0x0c14, 0x0c18, 0x0c1a, 0x0c1e, 0x0c24, 0x0c25, 0x0c26,
  ...
  const uint16_t classicConnection[] = {
    0x040f, 0x0411, 0x0413, 0x041b, 0x041c, 0x041f, 0x0428, 0x0429,
    0x042a, 0x0803, 0x0804, 0x080d, 0x0c37};
  ...
  check("synchronous accept targets Bluetooth address",
    !espble_hci_controller_policy_targets_handle(0x0429));
  check("synchronous reject targets Bluetooth address",
    !espble_hci_controller_policy_targets_handle(0x042a));
