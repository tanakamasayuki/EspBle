...
| GATT一覧/既知UUID discovery、Characteristic/Descriptor read/write | codec | ✅ | ✅ `gatt_read_write` | generic GATT app |
...
4. ✅ `gatt_read_write`: 汎用GATT Server/Client、一覧/既知UUID Discovery、応答あり/なしWrite、Descriptor Read/Write。
